...
// export default class DiscreteMath extends React.PureComponent {
//   render() {
//     return (
//       <View style={{flex: 1}}>
//         <Text>This is discrete math screen</Text>
//       </View>
//     );
//   }
// }
  ...
  const onPressMath = () => {
    if(baiToan==''||baiToan==undefined)
    {
      ...
      try{
        ...
        "latexExpression": '\\left[ \\begin{array} { l l } { 2 } & { 3 } \\\\ { 5 } & { 4 } \\end{array} \\right] \\times \\left[ \\begin{array} { l l l } { 0 } & { 3 } \\\\ { 1 } & { 5 } \\end{array} \\right]',
        "clientInfo": {
            "platform": "mobile",
            "mkt": "vi",
        },
